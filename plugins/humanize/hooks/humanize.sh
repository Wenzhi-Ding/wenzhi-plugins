...
REMINDER='【说人话要求·提醒】说人话规则本轮继续生效，完整规则见本会话前文的「【说人话要求】」条目：写完整句子；不用物理动作或空间关系写因果；不把多词说法压成自造短词，标签拿掉上下文要还能懂；不写翻译腔，转述外文材料时源的隐喻先拆成平白意义；不用 AI 套话和空洞大词；论断配具体量级；术语先用白话讲清、再挂名字。'
